...
INSERT INTO Creature (name, race, creatureClass, level, weapon, strength, dexterity, constitution, intelligence, wisdom, charisma, hitpoints) VALUES
					('Martti','Ihminen', 'Seppä', 1,  'Vasara', 8, 7, 8, 4, 4, 4, 10);
INSERT INTO Creature (name, race, creatureClass, level, weapon, strength, dexterity, constitution, intelligence, wisdom, charisma, hitpoints) VALUES
					('Maija', 'Jättiläinen', 'Ritari', 1, 'Miekka', 10, 10, 10, 10, 10, 10, 10);
