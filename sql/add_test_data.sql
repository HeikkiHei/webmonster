...
INSERT INTO Creature (owner, owner_id, name, race, creatureClass, level, strength, dexterity, constitution, intelligence, wisdom, charisma, hitpoints) VALUES
('heikkihei', 1, 'Brogan Hahn', 'Skaab', 'Barbarian', 1, 8, 7, 8, 4, 4, 4, 15);
INSERT INTO Creature (owner, owner_id, name, race, creatureClass, level, strength, dexterity, constitution, intelligence, wisdom, charisma, hitpoints) VALUES
('heikkihei', 1, 'Todd Siegler', 'Skeleton', 'Bard', 1, 10, 10, 10, 10, 10, 10, 15);

INSERT INTO Creature (owner, owner_id, name, race, creatureClass, level, strength, dexterity, constitution, intelligence, wisdom, charisma, hitpoints) VALUES
('kayttaja', 2, 'Guy Harrison', 'Kenku', 'Druid', 2, 10, 10, 10, 10, 10, 10, 15);
